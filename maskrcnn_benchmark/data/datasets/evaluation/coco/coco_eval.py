...
# from FCOS: https://github.com/tianzhi0549/FCOS/blob/f0a9731dac1346788cc30d5751177f2695caaa1f/fcos_core/data/datasets/evaluation/coco/coco_eval.py
...
class COCOResults(object):
    ...
    def __repr__(self):
        ...
        for task, metrics in self.results.items():
            ...
            metric_vals = ['{:.3f}'.format(v) for v in metrics.values()]
...
def check_expected_results(results, expected_results, sigma_tol):
    ...
    for task, metric, (mean, std) in expected_results:
        ...
        msg = (
            ...
            "{:.3f} vs. mean={:.3f}, std={:.4}, range=({:.3f}, {:.3f})"
