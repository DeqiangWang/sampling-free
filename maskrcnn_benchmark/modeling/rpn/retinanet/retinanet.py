...
from maskrcnn_benchmark.modeling.sampling_free import AdaptiveInitializer
...
class RetinaNetHead(torch.nn.Module):
    ...
    def __init__(self, cfg, in_channels):
        ...
        if cfg.TEST_ON or not cfg.MODEL.SAMPLING_FREE_ON:
            from math import log
            prior = cfg.MODEL.RETINANET.PRIOR_PROB
            nn.init.constant_(self.cls_logits.bias, -log((1 - prior) / prior))
        else:
            AdaptiveInitializer(cfg, self.cls_logits.bias, arch="RetinaNet")
