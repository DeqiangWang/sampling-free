...
class FastRCNNLossComputationSampling(object):
    """
...
class FastRCNNLossComputationFree(object):
    """
    Computes the loss for Faster R-CNN.
    Also supports FPN
    """
    ...
    def subsample(self, proposals, targets):
        ...
        # add corresponding label and regression_targets information to the bounding boxes
        # use all positive and negative examples
    ...
    def __call__(self, class_logits, box_regression):
        ...
        if pos_numel > 0:
            ...
            classification_loss = self.guided_loss_weighter(box_loss, classification_loss)
            return classification_loss, box_loss
        else:
...
def make_roi_box_loss_evaluator(cfg):
    ...
    guided_loss_weighter = GuidedLossWeighter(cfg.MODEL.CLASSIFICATION_SCALE)
