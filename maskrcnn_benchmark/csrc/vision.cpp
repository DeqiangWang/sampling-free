...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
  ...
  m.def("alone_bceloss_forward", &AloneBCELoss_forward, "AloneBCELoss_forward");
  m.def("alone_bceloss_backward", &AloneBCELoss_backward, "AloneBCELoss_backward");
  // dcn-v2
